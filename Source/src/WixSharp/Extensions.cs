...
namespace WixSharp
{
    ...
    public static partial class Extensions
    {
        ...
        /// <summary>
        /// Waits until the specified file becomes locked by another process or until the timeout expires.
        /// </summary>
        ...
        public static void WaitUntilFileLocked(this string filePath, int timeout = 5000)
        {
