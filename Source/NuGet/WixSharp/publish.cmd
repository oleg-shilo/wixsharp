...
rem dotnet nuget push WixSharp.Msi.Core.%ver%.snupkg -k %nugetkey% -s https://api.nuget.org/v3/index.json
rem dotnet nuget push WixSharp.Core.%ver%.snupkg -k %nugetkey% -s https://api.nuget.org/v3/index.json
